...
class Tracking(object):
    ...
    def __init__(self, project_name, experiment_name, default_backend: Union[str, List[str]] = 'console', debug=False, config=None, local_dir=None, wandb_mode='online'):
        ...
        if 'tracking' in default_backend or 'wandb' in default_backend:
            ...
            # wandb.mode = 'offline'
            if debug:
                wandb.init(project=project_name, name=experiment_name, mode=wandb_mode, config=config, settings=wandb.Settings(console="off"))
            else:
