dataset = dict(
    ...
    shards_pattern = "./datasets/simplevla_rl/mimicgen/iclr2025/stack_three_128_demos/**/*.tar",
...
# Log settings
seed = 42
outputs = "./checkpoints/opensora/mimicgen/iclr2025/09/07/stack_three_128_demos_debug"
wandb = True
epochs = 10000
log_every = 10
ckpt_every = 10000
