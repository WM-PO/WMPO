dataset = dict(
    ...
    shards_pattern = "./datasets/simplevla_rl/mimicgen/iclr2025/stack_three_1280_demos_dpo/**/*.tar",
    stats_path = "./checkpoints/openvla-oft/iclr2025/stack_three_d0_300_demos/openvla-7b+stack_three_d0_300_demos+b8+lr-0.0005+lora-r32+dropout-0.0--image_aug--stack_three_d0_300_demos--150000_chkpt/dataset_statistics.json",
    Ta = 8,
    To = 4,
    stride = 1,
    action_dim = 7,
...
# Log settings
seed = 42
outputs = "./checkpoints/opensora/mimicgen/iclr2025/09/12/stack_three_1280_demos"
wandb = True
epochs = 10000
log_every = 10
ckpt_every = 10000
