dataset = dict(
    ...
    shards_pattern = "./datasets/simplevla_rl/mimicgen/iclr2025/coffee_1280_demos_dpo/**/*.tar",
...
# Log settings
seed = 42
outputs = "./checkpoints/opensora/mimicgen/iclr2025/09/12/coffee_1280_demos"
wandb = True
epochs = 10000
log_every = 10
ckpt_every = 10000
