dataset = dict(
    ...
    shards_pattern = "./datasets/simplevla_rl/mimicgen/iclr2025/coffee_128_demos/**/*.tar",
    stats_path = "./checkpoints/openvla-oft/iclr2025/coffee_d0_300_demos/openvla-7b+coffee_d0_300_demos+b8+lr-0.0005+lora-r32+dropout-0.0--image_aug--coffee_d0_300_demos--150000_chkpt/dataset_statistics.json",
    Ta = 8,
    To = 4,
    stride = 1,
    action_dim = 7,
...
# Log settings
seed = 42
outputs = "./checkpoints/opensora/mimicgen/iclr2025/09/07/coffee_128_demos_debug"
wandb = True
epochs = 10000
log_every = 10
ckpt_every = 10000
