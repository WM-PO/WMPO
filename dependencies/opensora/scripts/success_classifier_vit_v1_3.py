...
启动示例（单机 8 卡）::
    ...
    torchrun --standalone --nproc_per_node=8 videomae_ddp.py \
        --pattern "./datasets/simplevla_rl/webdataset_shards/06/16_mp/**/*.tar" \
...
def train(args):
    ...
    # import tarfile
    # with tarfile.open("./datasets/simplevla_rl/webdataset_shards/06/17_mp/part_00/000000.tar", "r") as tar:
...
def get_args():
    ...
    ap.add_argument("--pattern", default="./datasets/simplevla_rl/mimicgen/square_128_demos/**/*.tar", help="glob pattern of WebDataset shards")
    ...
    ap.add_argument("--ckpt_path", default="./checkpoints/SimpleVLA-RL/terminal_model/neg_cross_v1_3/best_videomae.pth")
    # Distributed
