...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", default="./datasets/libero/libero_10_no_noops",
                        help="递归遍历的 hdf5 根目录")
    parser.add_argument("--output_dir", default="./datasets/simplevla_rl/webdataset_shards/libero/libero_10_no_noops",
                        help="保存 .tar 的目录")
