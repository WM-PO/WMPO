...
HYDRA_FULL_ERROR=1 python -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.wm.inference_config_path=./checkpoint_files/world_models/three_piece_assembly/P_1280/inference_cfg.py \
    actor_rollout_ref.wm.train_config_path=./checkpoint_files/world_models/three_piece_assembly/P_1280/train_mimicgen_cfg.py \
