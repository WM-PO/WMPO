...
# =========================
CFG = dict(
    TRAIN_PATTERN="/mnt/hdfs/zhufangqi/datasets/mimicgen/iclr2025/aloha/11/20/aloha_inference/**/*.tar",
    VAL_PATTERN="/mnt/hdfs/zhufangqi/datasets/mimicgen/iclr2025/aloha/11/20/aloha_inference/**/*.tar",
    IMG_SIZE=224,
    WINDOW=8,
    STRIDE_TRAIN=8,
    STRIDE_VAL=1,
